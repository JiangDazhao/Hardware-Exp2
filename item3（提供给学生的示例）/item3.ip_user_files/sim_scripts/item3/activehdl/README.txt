...
#
# Generated by export_simulation on Tue Jul 27 10:07:33 +0800 2021
#
################################################################################
...
'-reset_run' switch to the './item3.sh' script.
...
./item3.sh -noclean_files

For more information on the script, please type './item3.sh -help'.
