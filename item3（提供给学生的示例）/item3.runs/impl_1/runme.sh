...
HD_PWD='E:/hw_des_II/item3/item3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log item3_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source item3_wrapper.tcl -notrace
