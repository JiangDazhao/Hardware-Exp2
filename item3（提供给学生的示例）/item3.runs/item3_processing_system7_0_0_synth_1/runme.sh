...
HD_PWD='E:/hw_des_II/item3/item3.runs/item3_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log item3_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source item3_processing_system7_0_0.tcl
