...
HD_PWD='E:/hw_des_II/item3/item3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log item3_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source item3_wrapper.tcl
